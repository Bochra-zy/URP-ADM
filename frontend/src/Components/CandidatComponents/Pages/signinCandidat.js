...
const SignInCandidat = () => {
    ...
    try {
      ...
      if (token) {
        ...
        toast.success("Connexion réussie !", {
          position: "top-right",
          autoClose: 1000,
          onClose: () => navigate("/candidat/acceuil"),
        });
      } else {
  ...
  const handleResetPasswordSubmit = async (e) => {
    ...
    try {
      ...
      navigate("/signincandidat"); // Rediriger vers la page de connexion sans token
    } catch (err) {
    ...
    <>
      ...
      <main className="main-content mt-0">
        <div
          ...
          style={{
            backgroundImage: `url(${process.env.PUBLIC_URL}/images/background-candidat.jpg)`,
                ...
                <div className="card-body">
                  ...
                  <form role="form" onSubmit={handleLogin}>
                    ...
                    <p className="text-sm mt-3 mb-0">
                      <a href="/signupcandidat" className="text-dark font-weight-bolder">
