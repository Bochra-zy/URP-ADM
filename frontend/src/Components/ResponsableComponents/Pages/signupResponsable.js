...
const SignUpResponsable = () => {
    ...
    const handleSignUp = async (e) => {
        e.preventDefault();
        setError("");
        if (!nom || !prenom || !specialite || !email || !password || !nom_entreprise || !adresse_entreprise || !tel) {
        ...
        try {
            ...
            navigate("/signinresponsable"); // Rediriger vers la page de connexion après inscription
        } catch (err) {
                        ...
                        <ul className="navbar-nav mx-auto">
                            <li className="nav-item">
                                <a className="nav-link me-2" href="/">
                                    <i className="fa fa-home opacity-6 me-1"></i>
                                    Acceuil
                                </a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link me-2" href="/signinresponsable">
                                    ...
                                    <div className="col-md-6 mb-3">
                                        ...
                                        <div className="col-md-6 mb-3">
                                            <input
                                                ...
                                                onChange={(e) => setAdresse_entreprise(e.target.value)}
                                            />
                                        </div>
                                        ...
                                        <p className="text-sm mt-3 mb-0">
                                            ...
                                            <a href="/signincandidat" className="text-dark font-weight-bolder">
                                                Se connecter
                                            </a>
                                        </p>
                                    </form>
...
export default SignUpResponsable;